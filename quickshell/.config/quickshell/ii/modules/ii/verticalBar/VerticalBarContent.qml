...
Item { // Bar content region
    ...
    component HorizontalBarSeparator: Rectangle {
        Layout.leftMargin: Appearance.sizes.getBaseBarHeight(typeof barRoot !== "undefined" ? barRoot.screen.width : 1920) / 3
        Layout.rightMargin: Appearance.sizes.getBaseBarHeight(typeof barRoot !== "undefined" ? barRoot.screen.width : 1920) / 3
