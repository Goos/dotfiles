...
Item {
    ...
    implicitHeight: root.vertical ? (root.workspaceButtonWidth * root.workspacesShown) : Appearance.sizes.getBarHeight(typeof barRoot !== "undefined" ? barRoot.screen.width : 1920)
    ...
    Grid {
        ...
        Repeater {
            ...
            Button {
                ...
                implicitHeight: vertical ? Appearance.sizes.verticalBarWidth : Appearance.sizes.getBarHeight(typeof barRoot !== "undefined" ? barRoot.screen.width : 1920)
